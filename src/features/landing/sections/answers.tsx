            ...
            <article className="grid grid-cols-2 gap-3 max-w-2xl">
                {
                    answers.map((answer) => (
                        <div 
                            key={answer.title.length + answer.description.length}
                            className="border border-border-primary p-5 rounded-xl"
                        >
                            <h4 className="text-content-heading typografy-label">{answer.title}</h4>
                            <p className="text-content-body typografy-body-small">{answer.description}</p>
                        </div>
                    ))
                }
            </article>
